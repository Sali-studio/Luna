		...
		Options: []*discordgo.ApplicationCommandOption{
			{
				...
				Options: []*discordgo.ApplicationCommandOption{
					...
					{Type: discordgo.ApplicationCommandOptionInteger, Name: "iv", Description: "個体値 (0-31)", Required: true, MinValue: 0, MaxValue: 31},
					{Type: discordgo.ApplicationCommandOptionInteger, Name: "ev", Description: "努力値 (0-252)", Required: true, MinValue: 0, MaxValue: 252},
					{Type: discordgo.ApplicationCommandOptionInteger, Name: "level", Description: "レベル (1-100)", Required: true, MinValue: 1, MaxValue: 100},
...
func (c *PokemonCalculatorCommand) Handle(s *discordgo.Session, i *discordgo.InteractionCreate) {
	...
	if subCommand.Name == "stats" {
		c.handleStatsCalc(s, i, subCommand.Options)
	}
}

func (c *PokemonCalculatorCommand) handleStatsCalc(s *discordgo.Session, i *discordgo.InteractionCreate, options []*discordgo.ApplicationCommandOption) {
